...
###### INPUT DATA ######
#setwd("/Users/evelynguidry/Desktop/DSBA5122/R/Final_Project")
...
ui <- dashboardPage(
      ...
      tabItem(tabName = "subTab1",
              ...
              tabsetPanel(
                ...
                tabPanel("Bookings per Holiday", plotOutput("holiday"),
                         box("Above you can see the amount of bookings per Holiday. Because the Holidays are major US Holidays, we made sure to only include the data from US hotels in this graph. 
                         We also included the average lead times on each bar to give you an idea of how far ahead you should be planning to book.
  ...
  Our findings: Most bookings were made in the months of April/May and September/October in 2015-2017."
 , width = 12)
              )
      ),
  ...
  Our advice to you: Save the date for your next summer vacation for the hottest months of the year!", width = 12)
      ...
      tabItem(tabName = "subTab5",
              h2("Which type of hotel has more cancelations?"),
      ...
      tabItem(tabName = "subTab6",
              h3("More cancelations in the month means you might have a better chance of snagging a last minute booking!"),
